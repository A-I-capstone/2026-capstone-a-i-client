...
class TaskAddEditSheet extends StatefulWidget {
  final Task? task;
  final Function(String title, DateTime? dueDate, List<String> subtasks) onSave;

  const TaskAddEditSheet({
    super.key,
    this.task,
  ...
  static Future<void> show(
    ...
    Task? task,
    required Function(String title, DateTime? dueDate, List<String> subtasks) onSave,
  }) {
...
class _TaskAddEditSheetState extends State<TaskAddEditSheet> {
  ...
  void _submit() {
    ...
    widget.onSave(title, _selectedDueDate, subtasks);
          ...
          children: [
            Row(
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: const Icon(Icons.close_rounded, color: AppColors.ink, size: 28),
                ),
              ],
            ),
            ...
            Row(
              ...
              children: [
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: AppTypography.bodyMedium.copyWith(
                        ...
                        color: _selectedDueDate != null ? AppColors.ink : AppColors.slate,
                      ),
                    ),
                  ],
                ),
                BouncyButton(
                  ...
                  icon: const Icon(Icons.calendar_today_rounded, color: AppColors.ink, size: 20),
                  onTap: _pickDueDate,
                ),
              ],
            ),
            ...
            ListView.separated(
              ...
              itemBuilder: (context, index) {
                return Row(
                  children: [
                    const Icon(Icons.subdirectory_arrow_right_rounded, color: AppColors.slate, size: 22),
                    ...
                    Expanded(
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          hintText: '예: 자료 조사하기',
                          hintStyle: AppTypography.bodyMedium.copyWith(color: AppColors.border),
                          filled: true,
                          fillColor: AppColors.bg,
                    ...
                    if (_subtaskControllers.length > 1) ...[
                      ...
                      GestureDetector(
                        ...
                        child: const Icon(Icons.remove_circle_outline_rounded, color: AppColors.clay, size: 22),
                      ),
                    ],
                  ],
                );
